...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		aplhabetkey();
	    document.getElementById("d1").innerHTML="Você pressionou uma tecla do (alfa) beto";
		}
		else if(keyPressed >=48 && keyPressed<=57){
			numberkey()
			document.getElementById("d1").innerHTML="Você pressionou uma tecla numeriK";
		}
			...
			specialkey();
			document.getElementById("d1").innerHTML="Você pressionou uma tecla espacial";
		}
	    else{
		otherkey();
